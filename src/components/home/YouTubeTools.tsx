        ...
        <Card className="hover:shadow-md transition-shadow">
          <Link to="/growth-calculator">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                <h3 className="font-crimson text-lg font-semibold">Growth Rate Calculator</h3>
                <p className="text-gray-600 font-lato text-sm">Calculate your channel's subscriber growth rate</p>
              </div>
            </CardContent>
          </Link>
        </Card>

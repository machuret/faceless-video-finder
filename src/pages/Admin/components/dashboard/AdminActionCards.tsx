...
import { PlusCircle, UploadCloud, Upload, List, Tag, BookOpen, AlertTriangle, Users } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm">Register new users, assign admin roles, and manage existing user accounts.</p>
        </CardContent>
        <CardFooter>
          <Button asChild className="w-full">

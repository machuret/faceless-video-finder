...
const RevenuePerVideoRanking = () => {
  const { channels, isLoading, error, refetch } = useChannelRankings("revenue_per_video");
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-6 border-b border-gray-200">
        <h2 className="text-2xl font-bold text-gray-800">Revenue Per Video Ranking</h2>
        <p className="text-gray-600 mt-2">
          Channels ranked by estimated revenue generated per video.
        </p>
      </div>
      
      <RankingTable 
        channels={channels} 
        rankingMetric="revenue_per_video"
      />
    </div>
  );
};

export default RevenuePerVideoRanking;
